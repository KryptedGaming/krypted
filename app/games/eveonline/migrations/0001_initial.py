    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character_alt_type', models.CharField(choices=[('pvp_alt', 'PvP Alt'), ('cap_alt', 'Capital Alt'), ('industry_alt', 'Industry Alt'), ('useless_alt', 'Useless Alt')], max_length=255, null=True)),
                ('character_corporation', models.CharField(blank=True, max_length=255, null=True)),
                ('character_alliance', models.CharField(blank=True, max_length=255, null=True)),
