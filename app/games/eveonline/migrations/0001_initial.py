    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character_alt_type', models.CharField(blank=True, choices=[('super_alt', 'Super Alt'), ('rorqual_alt', 'Rorqual Alt'), ('cap_alt', 'Capital Alt'), ('industry_alt', 'Subcap PvE Alt'), ('subcap_pvp_alt', 'Subcap PvP Alt'), ('industry_alt', 'Industry Alt'), ('useless_alt', 'Useless Alt')], max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='EveCorporation',
