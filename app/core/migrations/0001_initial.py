    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('importance', models.CharField(blank=True, choices=[(b'1', b'Low'), (b'2', b'Medium'), (b'3', b'High')], max_length=12, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timezone', models.CharField(blank=True, choices=[(b'EU', b'EU'), (b'US', b'US')], max_length=2, null=True)),
