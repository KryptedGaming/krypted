...
urlpatterns += [
    ...
    url(r'^user/(?P<pk>\d+)/$', accounts.edit_user, name='edit-user'),
    url(r'^user/info/(?P<pk>\d+)/$', accounts.edit_user_info, name='edit-user-info'),
    url(r'^tutorial/$', accounts.new_user, name='tutorial'),
    url(r'^tutorial/complete/$', accounts.new_user_complete, name='tutorial-complete'),    
]
